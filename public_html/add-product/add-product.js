...
class ProdForm extends React.Component {
    ...
    handleInputProduct(event) {
      ...
      var validation_res = isCorrect($('#product_form').serializeArray(), this.state.err_msg)
      if (validation_res === true) {
        ...
        $.post('save-product.php', $('#product_form').serialize(), function( data ) {
            if (data === 'success') {
  ...
  render() {
    ...
    return e('div', {id:'product-add'}, 
            e('section', {id:'top-heading'}, 
             ...
             e('form', {action:'/', method:'GET'}, e('button', {type:'submit'}, 'Cancel'))),
            e('hr', null),
            e(ProdForm),
